    ...
    <section className={classes["main-content"]}>
      ...
      <Card className={classes["main-card"]}>
        <div className={classes["card-header"]}>
          <div className={classes["text-header"]}>
        ...
        <div className={classes["card-body"]}>
          <form onSubmit={detectForm(id, addProduct, editProduct)}>
            <div className={classes["form-group"]}>
              ...
              <input
                required
                className={classes["form-control txt"]}
                name="name"
                id="name"
                type="text"
            ...
            <div className={classes["form-group"]}>
              ...
              <Card sx={{ p: 2 }} className={classes["image-card"]}>
                ...
                <input
                  className={`${classes["form-control"]} ${classes.img}`}
                  name="image"
                  id="image"
                  type="file"
                  accept="image/*"
                ...
                {product.imageUrl === "" ? null : (
                  <input
                    ...
                    disabled
                    className={`${classes["form-control"]} ${classes.img} ${classes.txt}`}
                  />
                )}
              </Card>
            </div>
            ...
            <div className={classes["form-group"]}>
              ...
              <input
                required
                className={`${classes["form-control"]} ${classes.txt}`}
                name="price"
                id="price"
                type="text"
