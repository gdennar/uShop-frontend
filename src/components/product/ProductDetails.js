...
const ProductDetails = () => {
  ...
  return (
    <section>
      <ToastContainer />
      <div className={`container ${classes["product-product"]}`}>
          ...
          <>
            <div className={classes["product-details"]}>
              ...
              <div className={classes["product-content"]}>
                ...
                <Button
                  sx={{ backgroundColor: "var(--color-hover)", color: "#fff" }}
                  onClick={() => {
                    addToCart(product);
                  }}
                  className={classes["product-detail-btn"]}
                >
                  Add to cart
                </Button>
              </div>
        ...
        <Card className={classes["product-review-rate"]}>
